...
pkgincludedir = $(includedir)/test
pkglibdir = $(libdir)/test
pkglibexecdir = $(libexecdir)/test
...
am__EXEEXT_1 = stock$(EXEEXT)
am__installdirs = "$(DESTDIR)$(bindir)"
PROGRAMS = $(bin_PROGRAMS)
am__objects_1 =
am__objects_2 = StockMarshal.$(OBJEXT)
am_stock_OBJECTS = $(am__objects_1) $(am__objects_2) stock.$(OBJEXT)
stock_OBJECTS = $(am_stock_OBJECTS)
stock_LDADD = $(LDADD)
am__DEPENDENCIES_1 =
DEFAULT_INCLUDES = -I.
...
AR = ar
AUTOCONF = ${SHELL} /home/jj/Workspace/cpp/borealis-test/config/missing --run autoconf
AUTOHEADER = ${SHELL} /home/jj/Workspace/cpp/borealis-test/config/missing --run autoheader
AUTOMAKE = ${SHELL} /home/jj/Workspace/cpp/borealis-test/config/missing --run automake-1.11
AWK = gawk
BDBDIR = 
...
EGREP = /bin/grep -E
EXEEXT = 
EXTERNALINCLUDE = -I/home/jj/Workspace/cpp/borealis-test/external/bdb/stub -I/opt/borealis-tools/gsl/include   
EXTERNALLIB = -L/opt/borealis-tools/gsl/lib -lgsl -lgslcblas  
FGREP = /bin/grep -F
GREP = /bin/grep
GSLDIR = /opt/borealis-tools/gsl
GSLINCLUDE = -I/opt/borealis-tools/gsl/include
GSLLIB = -L/opt/borealis-tools/gsl/lib -lgsl -lgslcblas
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/jj/Workspace/cpp/borealis-test/config/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
NMSTLDIR = /opt/borealis-tools/nmstl
NMSTLINCLUDE = -I/opt/borealis-tools/nmstl/include
NMSTLLIB = -L/opt/borealis-tools/nmstl/lib -lNMSTL -lexpat -lpthread -lreadline -lncurses
NMSTLSUBDIR = 
OBJDUMP = objdump
OBJEXT = o
OCVDIR = 
...
STRIP = strip
VERSION = 0.1
XERCESCINCLUDE = -I/opt/borealis-tools/xercesc/include
XERCESCLIB = -L/opt/borealis-tools/xercesc/lib -lxerces-c
abs_builddir = /home/jj/Workspace/cpp/borealis-test
abs_srcdir = /home/jj/Workspace/cpp/borealis-test
abs_top_builddir = /home/jj/Workspace/cpp/borealis-test
abs_top_srcdir = /home/jj/Workspace/cpp/borealis-test
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/jj/Workspace/cpp/borealis-test/config/install-sh
...
INCLUDES = -I/opt/borealis-tools/xercesc/include   -I/opt/borealis-tools/nmstl/include                   \
...
clean-binPROGRAMS:
	...
	echo " rm -f" $$list; \
	rm -f $$list
stock$(EXEEXT): $(stock_OBJECTS) $(stock_DEPENDENCIES) 
	@rm -f stock$(EXEEXT)
	$(CXXLINK) $(stock_OBJECTS) $(stock_LDADD) $(LIBS)
...
include ./$(DEPDIR)/StockMarshal.Po
include ./$(DEPDIR)/stock.Po
